export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx6c946ca7fc0c295c",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b0eea8769d26136f7a166c5460001912",
  ...
  USERS: [
    {
      ...
      id: "oBdbH6DhKTW38-ons6rjkTQtJNZM",
      // 你想对他发送的模板消息的模板ID
  ...
  CALLBACK_TEMPLATE_ID: "	hXAnXUATkcuPLvp9wSWqWfbaCsD3AJaqAnyIqtF9v6U",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "	hXAnXUATkcuPLvp9wSWqWfbaCsD3AJaqAnyIqtF9v6U",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
